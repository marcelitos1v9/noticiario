...
-- Copiando dados para a tabela web-tcc.blog: ~8 rows (aproximadamente)
...
-- Copiando dados para a tabela web-tcc.blogimgs: ~22 rows (aproximadamente)
INSERT INTO `blogimgs` (`blogimgs_codigo`, `blogimgs_nome`) VALUES
	...
	(21, '646ae1bd0829a.png'),
	(22, '646ae2e85ae7a.png'),
	(23, '646ae2e87830e.png'),
	(24, '646ae2e893d1e.png');
...
-- Copiando dados para a tabela web-tcc.bloginfo: ~25 rows (aproximadamente)
INSERT INTO `bloginfo` (`bloginfo_codigo`, `bloginfo_titulo`, `bloginfo_corpo`, `bloginfo_data`) VALUES
	...
	(38, 'materia 1', 'feafssdg', '2023-05-22 03:30:05'),
	(39, 'teste de multiplas imagens ', 'ahegfhiaufijna aloe aoinf', '2023-05-22 03:35:04');
